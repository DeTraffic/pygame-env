...
class Agent:
    ...
    def __init__(self):
        ...
        self.model = Linear_QNet(1, 16, 4) #Linear_QNet(12, 256, 4)
    ...
    def get_state(self, game):
        ...
        state = [
            ...
            state["left_traffic_light"],
            state["right_traffic_light"],
            state["top_traffic_light"],
            state["bottom_traffic_light"],
        ]
...
def train():
    ...
    record = 0
    agent = Agent()
    game = Game("detraffic-pygame-env", 1280, 724, 60)
    while True:
        # get old state
